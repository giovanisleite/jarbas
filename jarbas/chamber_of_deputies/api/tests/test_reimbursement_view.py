...
from jarbas.chamber_of_deputies.api.tests import get_sample_reimbursement_api_response
...
class TestListApi(TestCase):
    ...
    def setUp(self):
        ...
        self.url = resolve_url('chamber_of_deputies_api:reimbursement-list')
...
class TestRetrieveApi(TestCase):
    ...
    def setUp(self):
        ...
        url = resolve_url('chamber_of_deputies_api:reimbursement-detail',
...
class TestReceiptApi(TestCase):
    ...
    def setUp(self):
        ...
        self.url = resolve_url(
            'chamber_of_deputies_api:reimbursement-receipt', document_id=self.reimbursement.document_id)
        self.url_no_receipt = resolve_url(
            'chamber_of_deputies_api:reimbursement-receipt', document_id=self.reimbursement_no_receipt.document_id)
